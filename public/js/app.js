...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  var table = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#example').DataTable({
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').on('keyup', '#search-input', function () {
    console.log('Search', jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());
    table.search(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val()).draw();
  });
});
